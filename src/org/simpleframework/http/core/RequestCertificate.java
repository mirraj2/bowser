...
class RequestCertificate implements Certificate {
    ...
    */
   public RequestCertificate(Entity entity, Monitor monitor) {
      this.challenge = new Challenge(entity, monitor);
   ...
   private static class Challenge implements CertificateChallenge {
      ...
      /**
       * This is the monitor used to keep track of the HTTP transaction.
       */
       ...
       * @param monitor this monitor used to track the transaction
       */
      public Challenge(Entity entity, Monitor monitor) {
         this.channel = entity.getChannel();
         this.certificate = channel.getCertificate();
