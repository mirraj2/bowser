...
class ActionDistributor extends Daemon implements Distributor {
   ...
   /**
    * This method will clear the set of actions to that the next 
    * loop will not get confused as to which actions are registered.
    * Without clearing the actions it is possible for them to get
    * executed when the next operation occurs for a registered set.
    * 
    * @param set this is the set of actions to be cleared
    */
